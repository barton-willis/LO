...
\begin{alphalist}
    ...
    \item Learn factoring techniques for quadratics and for the prime factorization of whole numbers.
...
\item  Analyze quadratic functions including find the vertex and axis of symmetry.
...
On completion of this course, students will:
\begin{alphalist}
\item Be able to solve systems of linear equations using multiple methods, including row reduction to eschelon form, row reduction to eschelon form, and multiplication by a matrix inverse.
